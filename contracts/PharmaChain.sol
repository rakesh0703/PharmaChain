...
contract PharmaChain {
   ...
   function getAdmin(address _id) public view returns (string memory , Status, address , address, uint) {
    ...
    function loginSuperAdmin(address _id) public view returns (bool){
        if(superAdmin == _id){
            return true;
        }
        return false;
    }
    function loginAdmin(address _id) public view returns (bool){
        if(admins[_id].status == Status.Aproved){
            return true;
        }   
        return false;
        
    }
    function loginMfg(uint _id) public view returns (bool){
        if(mfgs[_id].status == Status.Aproved)
            return true;
            
        return false;
        
    }
    function loginSup(uint _id) public view returns (bool){
        if(sups[_id].status == Status.Aproved){
            return true;
        }
       return false;
